...
export const Dashboard: React.FC<DashboardProps> = ({ onNavigate, recentActivities }) => {
  const stats = [
          ...
          <DataRepeater 
            ...
            emptyState={
              <div style={{ textAlign: 'center', padding: '2rem', color: 'var(--color-text-tertiary)' }}>
                No recent activity. Start reading to see it here!
              </div>
            }
            renderItem={(item, i) => (
              <div 
                ...
                style={{ 
                  ...
                  borderBottom: i < recentActivities.length - 1 ? '1px solid var(--color-border-primary)' : 'none' 
                }}
              >
                <div>
